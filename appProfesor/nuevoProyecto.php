...
<head>
    ...
    <!-- Tittle -->
    <title>Biblioteca de Proyectos | Nuevo proyecto</title>    
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container-fluid">
                    ...
                    <div class="col-8 col-md-6 text-end text-uppercase fs-5">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                ?>
                                <a class="fs-6 fw-light" href="./buscador.php">Buscador</a>
        ...
        <!-- Nuevo Proyecto -->
        <div class="row" id="formNuevoProy">
            <div class="col p-4">
                <div class="row mb-4">
                    <div class="col text-center">
                        <label class="form-label h4" for="titulo">Nuevo Proyecto</label>
                    </div>
                </div>
                <div class="row mb-0 mb-lg-4">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4 offset-0 offset-sm-2 offset-md-3 offset-lg-1 mb-2 mb-lg-0">
                        <input class="form-control" type="text" name="nombre" id="nombre" placeholder="Titulo proyecto..." maxlength="256">
                    </div>
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4 offset-0 offset-sm-2 offset-md-3 offset-lg-0 mb-2 mb-lg-0">
                        <input class="form-control" type="text" name="alumno" id="alumno" placeholder="Alumno..." maxlength="256">
                    </div>
                    <div class="col-12 col-sm-8 col-md-6 col-lg-2 offset-0 offset-sm-2 offset-md-3 offset-lg-0 mb-2 mb-lg-0">
                        <select class="form-select text-star text-lg-end" id="busquedaCiclo">
                            <!-- options en selectCiclos() del js -->
                        </select>
                    </div>
                </div>
                <div class="row mb-0 mb-lg-4">
                    <div class="col-12 col-sm-8 col-md-6 col-lg-8 offset-0 offset-sm-2 offset-md-3 offset-lg-1 mb-2 mb-lg-0 order-2 order-lg-1">
                ...
                <div class="row">   
                    <div class="col-12 col-sm-8 col-md-6 col-lg-4 offset-0 offset-sm-2 offset-md-3 offset-lg-1 mb-2 mb-lg-0">
                        <div class="row align-items-center">                            
                            <div class="col-10 col-sm-10 col-md-10 pe-0 me-0">
                            ...
                            <div class="col-auto g-0">
                                <button class="btn btn-light align-self-center p-1" id="btnEtiqueta" onclick="buscadorAniadirEtiquetas($('#busquedaEtiqueta').val())">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.7em" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                ...
                <div class="row mt-3">
                    <div class="col text-center text-lg-start col-12 col-sm-8 col-md-6 col-lg-5 offset-0 offset-sm-2 offset-md-3 offset-lg-1">
                        <button class="btn btn-light editarArchivo" onclick="subirPDF()">Subir PDF</button>
                        <input id="subirArchivo" type="file" accept="application/pdf" hidden="true">                
                    </div>                    
                    <div class="col text-center text-lg-end col-12 col-sm-8 col-md-6 col-lg-5 offset-0 offset-sm-2 offset-md-3 offset-lg-0">
                        <button class="btn btn-light editarArchivo" onclick="confirmarAniadir()">Añadir Proyecto</button>
                        <button class="btn btn-light btnEliminar" onclick="volver()">Volver</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center">
                        <span id="nuevoProyAdvises"></span>
                    </div>
                </div>
            </div>
        </div>        
