<?php
    // creamos y destruimos la sesion para reiniciar el login
    @session_start();
    session_destroy();
?>
...
<head>
    ...
    <!-- Google Login Meta -->
    <!-- <meta name="google-signin-client_id" content="845694346795-lf5duj2d4ahpbt8hsikcjpqd8u4o4ifb.apps.googleusercontent.com"> -->
    <!-- Tittle -->
...
<body>  
    ...
    <div class="container-fluid">
            ...
            <div class="col">
                ...
                <div class="row my-3">
                    ...
                    <div class="col-8 col-md-6 text-end text-uppercase fs-5">
                        <p class="h1 text-uppercase text-decoration-underline">Biblioteca de proyectos</p>                        
                    </div>                             
                </div>

                <div class="row">
                    <div class="col imgCol p-0">
                        <img height="250em" width="100%" src="assets/imagenes/send_email.jpg" alt="imagen de portatil">                        
                    </div>
                </div>
            </div>    
        </div>
        ...
        <div class="row justify-content-center" id="loginGoogle"></div>
        <div class="row mt-5">
            <div class="col-auto m-auto">
                <div class="row text-center">
                    <div class="col mb-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-7 form-floating mb-3">
                        ...
                        <label class="ms-3" for="user">Email</label>
                    </div>
                    <div class="col-7 form-floating mb-3">
                    ...
                    <div class="col-2">
                        <button type="button" id="btnAcceso" class="btn btn-primary" onclick="loginProfesor()">Acceder</button>
                    </div>
                </div>                
            </div>            
        </div>     
        <div class="row justify-content-center" id="loginProfesores"></div>
    ...
    <!-- Bootstrap JS -->
    <script src="assets/librerias/bootstrap.js"></script>
    <!-- JQuery-->
    <script src="assets/librerias/jquery-3.6.js"></script>
    <script src="assets/librerias/jquery.redirect.js"></script>
    <!-- Custom JS -->
