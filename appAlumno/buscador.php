<?php
    ...
    if (isset($_POST['nombre'] )){
        ...
        $_SESSION['imagenURL'] = $_POST['imagen'];
        ...
        <div class="row" id="cabecera">    
            <div class="col">
                ...
                <div class="row my-3" id="user">
                    ...
                    <div class="col-auto">
                        <img src="<?php echo $_SESSION['imagenURL'] ?>" width="70em" height="70em" alt="imagen de usuario">                                
                    </div>                   
                </div>
            ...
            <div class="col-md-8">                
                    <div class="row">     
                        ...
                        <div class="col-12 col-sm-4">                            
                            <select class="form-select text-end" id="busquedaCiclo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4 order-1 order-sm-2">
                            <select class="form-select text-end" id="busquedaCurso">
